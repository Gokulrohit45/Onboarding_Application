                                ...
                                <div className="flex-1 px-16 pt-6 pb-12 font-sans text-gray-900">
                                    ...
                                    <div className="flex justify-between items-start mb-8">
                                        ...
                                        <div
                                            ...
                                            suppressContentEditableWarning={true}
                                        >
                                            <div className="text-xl font-bold mb-4">Dear <span id="pdf-candidate-name">{formData.toName || 'Mr.[Name]'}</span>,</div>
                    ...
                    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
                        <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md overflow-hidden transform animate-in zoom-in-95 duration-300">
                            <div className="bg-indigo-600 px-8 py-8 text-white relative">
                                <button onClick={() => { setShowMailModal(false); setSelectedMailItem(null); setCcEmails([]); setRecipientEmail(''); }} className="absolute right-6 top-6 text-white/50 hover:text-white transition-colors">
                                    <X className="w-5 h-5" />
                                </button>
                                ...
                                <div>
                                    ...
                                    <div className="relative flex gap-2">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => {
                                                const input = document.getElementById('cc-input-probation');
